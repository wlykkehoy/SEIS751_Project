<div class="container ">
  <div class="row justify-content-md-center footer-nav">
    <div class="col-md-auto">
      <a href="index.php">Home</a>
    </div>
    <div class="col-md-auto">
      Featured
      <li><a href="how-sake-is-made.php">How Sake is Made</a></li>
    ...
    <div class="col-md-auto">
      About
      <li><a href="content-map.php">Content Map</a></li>
  ...
  <div class="row justify-content-md-center footer-copyright">
    &copy; 2019-<?php echo date("Y");?> Wade Lykkehoy
  </div>
</div>
